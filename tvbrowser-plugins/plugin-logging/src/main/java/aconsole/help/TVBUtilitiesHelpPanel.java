...
public class TVBUtilitiesHelpPanel extends JPanel implements  HyperlinkListener {
  ...
  /**
   * Hilfsmethode f�r {@link #hyperlinkUpdate(HyperlinkEvent) hyperlinkUpdate}.
   * <p>
   * F�gt die aktuelle Seite zum mHistoryStack hinzu.
   */
  ...
  /**
   * Hilfsmethode f�r {@link #actionPerformed(ActionEvent)}.
   * <P>
