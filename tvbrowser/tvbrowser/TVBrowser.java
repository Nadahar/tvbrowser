...
public class TVBrowser extends JFrame implements ActionListener, DateListener, MainApplication {
  ...
  private JButton updateBtn, settingsBtn, searchBtn;
  ...
  public void actionPerformed(ActionEvent event) {
    ...
    if (event.getSource()==updateBtn || event.getSource()==updateMenuItem) {
      ...
      this.updateProgramTableSkin();
        ...
        private void onDownloadDone() {
                ...
                try {
                  DayProgram dayProgram = DataService.getInstance().getDayProgram(null);
