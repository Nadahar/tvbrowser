...
public interface SelectableItemRendererCenterComponentIf<E> {
   ...
   */
  public JPanel createCenterPanel(JList<? extends SelectableItem<E>> list, E value, int index, boolean isSelected, boolean isEnabled, JScrollPane parentScrollPane, int leftColumnWidth);
