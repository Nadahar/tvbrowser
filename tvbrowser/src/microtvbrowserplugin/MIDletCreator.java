  ...
  public void run(){
    try {
      ...
      switch (this.mtbp.getExportLevel()){
        ...
        case (4):{
          dataToExport = new ProgramFieldType[20];

          dataToExport[0] = ProgramFieldType.ACTOR_LIST_TYPE;
          dataToExport[1] = ProgramFieldType.AGE_LIMIT_TYPE ;
          dataToExport[2] = ProgramFieldType.DESCRIPTION_TYPE;
          dataToExport[3] = ProgramFieldType.DIRECTOR_TYPE ;
          dataToExport[4] = ProgramFieldType.EPISODE_TYPE ;
          dataToExport[5] = ProgramFieldType.GENRE_TYPE ;
          dataToExport[6] = ProgramFieldType.MODERATION_TYPE ;
          dataToExport[7] = ProgramFieldType.MUSIC_TYPE ;
          dataToExport[8] = ProgramFieldType.NET_PLAYING_TIME_TYPE ;
          dataToExport[9] = ProgramFieldType.ORIGIN_TYPE ;
          dataToExport[10] = ProgramFieldType.ORIGINAL_EPISODE_TYPE ;
          dataToExport[11] = ProgramFieldType.ORIGINAL_TITLE_TYPE ;
          dataToExport[12] = ProgramFieldType.PRODUCTION_YEAR_TYPE ;
          dataToExport[13] = ProgramFieldType.REPETITION_OF_TYPE ;
          dataToExport[14] = ProgramFieldType.REPETITION_ON_TYPE ;
          dataToExport[15] = ProgramFieldType.SCRIPT_TYPE ;
          dataToExport[16] = ProgramFieldType.SHORT_DESCRIPTION_TYPE ;
          dataToExport[17] = ProgramFieldType.SHOWVIEW_NR_TYPE ;
          dataToExport[18] = ProgramFieldType.URL_TYPE ;
          dataToExport[19] = ProgramFieldType.VPS_TYPE ;
          break;
        }
      }
