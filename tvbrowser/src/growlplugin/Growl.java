...
public class Growl {
   ...
   * @param inImage -
   *          The NSImage Icon for your Application
   */
  public Growl(String inAppName, NSImage inImage) {

    this(inAppName, inImage.TIFFRepresentation(), new NSArray(), new NSArray(),
        false);
   ...
   *          The Name of your "Application"
   * @param inImageData -
   *          The NSData for your NSImage
   */
  Growl(String inAppName, NSData inImageData) {

    this(inAppName, inImageData, new NSArray(), new NSArray(), false);
  }
  ...
  Growl(String inAppName, String inImagePath) {
    ...
    this(inAppName, new NSImage(inImagePath, false).TIFFRepresentation(),
   ...
   *          The Name of your "Application"
   * @param inAllNotes -
   *          A String Array with the name of all your notifications
   * @param inDefNotes -
   *          A String Array with the na,es of the Notifications on by default
   */
  Growl(String inAppName, String[] inAllNotes, String[] inDefNotes) {

    this(inAppName, new NSData(), new NSArray(inAllNotes), new NSArray(
        inDefNotes), false);
  }
   ...
   *          The Name of your "Application"
   * @param inImageData -
   *          The Data of your "Application"'s icon
   * @param inAllNotes -
   *          The NSArray of Strings of all your Notifications
   * @param inDefNotes -
   *          The NSArray of Strings of your default Notifications
   * @param registerNow -
   *          Since we have all the necessary info we can go ahead and register
   */
  Growl(String inAppName, NSData inImageData, NSArray inAllNotes,
    ...
    theCenter = (NSDistributedNotificationCenter) NSDistributedNotificationCenter
        .defaultCenter();
  ...
  public boolean register() {
    ...
    if (!registered) {
      ...
      String[] keys = { GROWL_APP_NAME, GROWL_NOTIFICATIONS_ALL,
   ...
   * 
   * @param inNotificationName -
   *          The name of one of the notifications we told growl about.
   * @param inIconData -
   *          The NSData for the icon for this notification, can be null
   * @param inTitle -
   *          The Title of our Notification as Growl will show it
   * @param inDescription -
   ...
   * @throws Exception
   *           When a notification is not known
   */
  public void notifyGrowlOf(String inNotificationName, NSData inIconData,
    ...
    theCenter.postNotification(GROWL_NOTIFICATION, (String) null, noteDict,
        true);
  }
  ...
  public void notifyGrowlOf(String inNotificationName, String inTitle,
    ...
    notifyGrowlOf(inNotificationName, (NSData) null, inTitle, inDescription,
        (NSDictionary) null);
  }
  ...
  public void notifyGrowlOf(String inNotificationName, NSImage inImage,
    ...
    notifyGrowlOf(inNotificationName, inImage.TIFFRepresentation(), inTitle,
        inDescription, inExtraInfo);
  }
   ...
   *          The name of one of the notifications we told growl about.
   * @param inImagePath -
   *          Path to the image for this notification
   * @param inTitle -
   *          The Title of our Notification as Growl will show it
   * @param inDescription -
   *          The Description of our Notification as Growl will display it
  ...
  public void notifyGrowlOf(String inNotificationName, String inImagePath,
    ...
    notifyGrowlOf(inNotificationName, new NSImage(inImagePath, false), inTitle,
        inDescription, (NSDictionary) null);
  }
   ...
   * @throws Exception
   *           when an element of the array is not in the allowedNotifications
   */
