...
package devplugin; import java.util.Properties; import javax.swing.Timer; import java.util.jar.*; import javax.swing.Icon; import java.io.InputStream; import java.awt.event.*; import util.exc.*; class TimerListener implements ActionListener { public void actionPerformed(ActionEvent event) {
   ...
   */ final public static PluginManager getPluginManager() { return pluginManager; }
   
   /**
   * Called by the host-application.
   */ final public void setParent(java.awt.Frame parent) { this .parent=parent; } 
   ...
   */ final public void setJarFile(java.io.File jarFile) throws TvBrowserException {
   		try {
			...
			throw new TvBrowserException(getClass(), "error.1" ,"Setting file failed!\n({0})" , exc);
		}
  	}
   ...
   * to the file system.
   */
  public Object storeData() { return null ; } 
  ...
  public Properties storeSettings() { return null ;  }
   ...
   * this feature.
   */ public String getContextMenuItemText() { return null ;} 
   ...
   *
   */ public SettingsTab getSettingsTab() { return null ; } 
