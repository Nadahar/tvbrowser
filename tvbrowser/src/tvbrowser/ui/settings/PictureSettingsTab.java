...
public class PictureSettingsTab extends AbstractSettingsTab {
  ...
  public JPanel createSettingsPanel() {
    try {
      ...
      pb.add(mHelpLabel, cc.xyw(1,y+2,9));
      ...
      JPanel scrollPanel = new JPanel(new FormLayout("default:grow","fill:default:grow"));
  ...
  public void saveSettings() {
    ...
    Settings.propPictureDuration.setInt(((Integer)mDuration.getValue()).intValue());
