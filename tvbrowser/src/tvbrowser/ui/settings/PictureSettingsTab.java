...
public class PictureSettingsTab implements SettingsTab {
  ...
  public JPanel createSettingsPanel() {
    mPictureSettings = new PictureSettingsPanel(Settings.propPictureType.getInt(),Settings.propPictureStartTime.getInt(),Settings.propPictureEndTime.getInt(),Settings.propIsPictureShowingDescription.getBoolean(), true, true);
