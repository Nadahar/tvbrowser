 ...
 */
public class ChannelChooser extends JLabel {
  ...
  public ChannelChooser(ProgramTableScrollPane programTableScrollPane) {
    super(new ImageIcon("imgs/down16.gif"));
    ...
    mProgramTableScrollPane = programTableScrollPane;
  }
  

  
  private void handleMouseEntered(MouseEvent evt) {
    Frame parent = JOptionPane.getFrameForComponent(this);
    if (win==null) {
      win=new ChannelChooserWindow(parent);
    }
  ...
  // inner class ChannelChooserWindow
  ...
  class ChannelChooserWindow extends JWindow implements MouseInputListener {
    ...
    public ChannelChooserWindow(Frame parent) {
      super(parent);
    ...
    public void setChannel(Channel channel) {
      mProgramTableScrollPane.scrollToChannel(channel);
    }
  ...
  // inner class ChannelItem
  
  
  protected class ChannelItem extends JLabel {
