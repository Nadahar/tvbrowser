...
public class TVBrowser {
  ...
  */
  ...
  /** The current version. */
  public static final devplugin.Version VERSION=new devplugin.Version(2,60,false,ALL_VERSIONS[0] + ((mIsTransportable = new File("settings").isDirectory()) ? " transportable" : ""));
