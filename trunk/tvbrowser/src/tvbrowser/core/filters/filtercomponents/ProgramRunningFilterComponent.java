...
/**
 * Filtert ob eine Sendung schon gelaufen ist, gerade läuft oder noch laufen wird
 * 
 * @author bodo
 */
public class ProgramRunningFilterComponent implements FilterComponent {
    ...
    public boolean accept(Program program) {
        ...
        if (bitSet(mSelectedBits, NOTYETSTARTED) && !program.isExpired() && !program.isOnAir()) {
            return true;
        }
    ...
    public JPanel getPanel() {
        ...
        _checkBox[2] = new JCheckBox(mLocalizer.msg("notyetstarted","Not yet started"));
     ...
     * Der Lokalizer
     */
    private static final util.ui.Localizer mLocalizer = util.ui.Localizer.getLocalizerFor(ProgramRunningFilterComponent.class);    
