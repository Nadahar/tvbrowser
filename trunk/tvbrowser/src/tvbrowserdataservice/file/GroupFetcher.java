...
public class GroupFetcher {
  ...
  private static java.util.logging.Logger mLog = java.util.logging.Logger.getLogger(GroupFetcher.class.getName());
   ...
   */
  public ArrayList getChannelGroups(Properties settings) throws IOException {
