...
public class DataFoxChannelContainer {
  ...
  /**
   * Creates a new instance of DataFoxChannelContainer
   */
  public DataFoxChannelContainer(String id, String name, String baseUrl, String iconUrl, String timeString) {
    this.name = name;
