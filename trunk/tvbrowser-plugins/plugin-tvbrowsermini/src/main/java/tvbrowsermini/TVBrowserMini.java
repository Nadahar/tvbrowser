...
public class TVBrowserMini extends Plugin {
  ...
  public PluginInfo getInfo() {
    ...
    String author = "Bodo Tasche, Ren� Mach, Benedikt Grabenmeier";
        ...
        new Thread() {
          public void run() {
            if (TVBrowserMini.mInstance.mSettings.getProperty("accept").equals("1")) {
              ...
              JOptionPane.showMessageDialog(UiUtilities.getBestDialogParent(getParentFrame()), "Sie m�ssen erst die Einverst�ndniserkl�rung akzeptieren!");
            }
          }
        }.start();
      }
