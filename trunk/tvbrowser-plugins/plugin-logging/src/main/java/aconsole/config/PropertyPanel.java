...
public class PropertyPanel implements SettingsTab{
	...
	class ColorLink implements Link{
		ColorProperty prop;
		ColorButton btn;
		public void reset(){btn.setColor(prop.get());};
		public void save(){prop.set(btn.getColor());};
	}
	Vector<Link> linklist=new Vector<Link>();
	public int addColorButton(ColorProperty src,String label,String tooltip,FormLayout layout,PanelBuilder panelBuilder,CellConstraints cc,int row){
	...
	public PropertyPanel() {
		...
		FormLayout layout=new FormLayout("5dlu, pref, pref,default:grow",
		"pref, 5dlu");
		...
		row+=addColorButton(AConsole.getLevelSevereText()
				...
				,mLocalizer.msg("LevelSevereText.tooltip", "")
				,layout,panelBuilder,cc,row);
		row+=addColorButton(AConsole.getLevelWarningText()
				...
				,mLocalizer.msg("LevelWarningText.tooltip", "")
				,layout,panelBuilder,cc,row);
		row+=addColorButton(AConsole.getLevelInfoText()
				...
				,mLocalizer.msg("LevelInfoText.tooltip", "")
				,layout,panelBuilder,cc,row);
		row+=addColorButton(AConsole.getLevelOtherText()
				...
				,mLocalizer.msg("LevelOtherText.tooltip", "")
				,layout,panelBuilder,cc,row);
