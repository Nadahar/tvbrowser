...
public class SoundReminder extends Plugin {
  protected static Localizer mLocalizer = Localizer.getLocalizerFor(SoundReminder.class);
  ...
  public PluginInfo getInfo() {
    return new PluginInfo(SoundReminder.class, mLocalizer.msg("title","Sound reminder"), mLocalizer.msg("description","Playes a sound for title of programs"), "René Mach", "GPL");
  }
  ...
  public void readData(ObjectInputStream in) throws IOException, ClassNotFoundException {
    ...
    int n = in.readInt(); //read number of entries
  ...
  public ActionMenu getButtonAction() {
    ContextMenuAction openDialog = new ContextMenuAction(mLocalizer.msg("editSoundList", "Edit sound list"),createImageIcon("status","audio-volume-high",16));
  ...
  private class SoundTablePanel extends JPanel {
      ...
      mTable.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
        public void valueChanged(ListSelectionEvent e) {
          if(!e.getValueIsAdjusting()) {
            ...
            String value = (String)mTableModel.getValueAt(mTable.getSelectedRow(),2);
    ...
    private void selectAudioFile(int row) {
      final String[] extArr = { ".wav", ".aif", ".rmf", ".au", ".mid" };
      String soundFName = (String)mTable.getValueAt(row,2);
      String msg = mLocalizer.msg("settings.soundFileFilter", "Sound file ({0})",
          "*.wav, *.aif, *.rmf, *.au, *.mid");
