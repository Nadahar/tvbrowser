...
public class SoundReminderSettingsTableModel extends AbstractTableModel {
   ...
   */
  protected SoundReminderSettingsTableModel(ArrayList<SoundEntry> entries) {
  ...
  public Object getValueAt(int rowIndex, int columnIndex) {
    if(!mData.isEmpty() && rowIndex >= 0) {
      SoundSettingsEntry entry = mData.get(rowIndex);
  ...
  protected ArrayList<SoundEntry> getChangedList() {
    ArrayList<SoundEntry> newList = new ArrayList<SoundEntry>(mData.size());
