...
{
    /// <summary>
    /// Controll-Class from PocketTVBrowser
    /// </summary>
    public class TVBrowserControll
    {
        ...
        public ArrayList getBroadcasts(String channelId, DateTime date)
        {
            ...
            if (this.dB)
            {
                if (DateTime.Now.Hour < 2) //show last broadcasts of the previous day
                {
                    DateTime dateBefore = date.AddDays(-1);
                    String monthB = "";
                    String dayB = "";
                    if (dateBefore.Month < 10)
                        monthB += "0";
                    monthB += dateBefore.Month;
                    ...
                    String strEndB = this.dbReader["end"].ToString();
                    if (!strStartB.Equals(""))
                    {
            ...
            while ((input = re.ReadLine()) != null)
            {
                ...
                else if (input.StartsWith("[$reminderMinutes]"))
                {
                    ...
                    if (intInput == 0)
                        ...
                        this.soundReminderTime = 0;
                    else if (intInput == 2)
                        this.soundReminderTime = 5;
                    else if (intInput == 3)
                        this.soundReminderTime = 10;
                    else if (intInput == 4)
                        this.soundReminderTime = 15;
                    else if (intInput == 5)
                        this.soundReminderTime = 30;
                    else if (intInput == 6)
                        this.soundReminderTime = 60;
                    else if (intInput == 7)
                        this.soundReminderTime = 120;
                }
